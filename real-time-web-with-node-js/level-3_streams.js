 ...
 * 2. Next, listen to the readable event on the newly created stream and give 
 * it a callback.
 * 3. Inside the callback, read the data chunks from the stream and print them 
 * to the console using console.log() - you might want to use a while loop to 
 */
var fs = require('fs');
 ...
 * writable stream.
 * 1. You'll need to consult the pipe documentation to figure out the option which 
